...
import pp_disamb.german_baseline_scores.network_cross_entropy
from pp_disamb.utils.nn_helper import softmax
from pp_disamb.utils.ranking_loss import ranking_loss_all


class PPDisambiguator(pp_disamb.german_baseline_scores.network_cross_entropy.PPDisambiguator):
